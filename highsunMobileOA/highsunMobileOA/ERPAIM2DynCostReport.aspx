<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ERPAIM2DynCostReport.aspx.cs" Inherits="highsunMobileOA.ERPAIM2DynCostReport" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function forward(obj) {
            var ComID = obj.id;
            URL = "ERPAIM2DynCost4ProjectReport.aspx?ComID=" + ComID;
            location.href = URL;
        }
    </script> 
</head>
<body>
    ...
    <script>
        $.post('/json/PublicHandler.ashx?Method=SearchERPAIM2DynCostReport', function (item) {
            var result = item[0];
            var ProjectCompanyName = item[1];
            var TotalAIM = item[2];
            var TotalSOFARHASAMT = item[3];
            var TotalSOFARTOAMT = item[4];
            var text = "";
            if (result.length != 0) {
                ...
                $('#container').highcharts({
                    ...
                    series: [{
                        ...
                        name: '动态成本',
                        data: TotalSOFARHASAMT,
                        color: '#EE0000'
                    }, {
                        name: '差异',
                        data: TotalSOFARTOAMT,
                        color: '#68838B'
                    }]
                });
