<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="trendtest.aspx.cs" Inherits="highsunMobileOA.trendtest" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#day').change(function () {
                ...
                $.post('/json/PublicHandler.ashx?Method=SearchBaihuoTrend', function (result) {
                    if (result.success) {
