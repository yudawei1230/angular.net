...
namespace WebSite.Comman
{
    public class MessageBox
    {
        ...
        {
            //Response.Write("<script>alert('帐户审核通过！现在去为企业充值。');window.location=\"" + pageurl + "\"</script>");
            page.ClientScript.RegisterStartupScript(page.GetType(), "message", "<script language='javascript' defer>alert('" + msg + "');window.open(\"" + url + "\")</script>");
        ...
        public void AlertMessage(System.Web.UI.Page page, string strMsg)
        {
            ...
            page.ClientScript.RegisterStartupScript(page.GetType(), "Login_Alert_Script", script.ToString());
        }
    }
}