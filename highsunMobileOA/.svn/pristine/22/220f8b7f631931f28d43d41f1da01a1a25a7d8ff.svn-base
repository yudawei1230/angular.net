<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="baihuoFloorMonthReport.aspx.cs" Inherits="highsunMobileOA.baihuoFloorMonthReport" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#month').change(function () {
                ...
                $.post('/json/PublicHandler.ashx?Method=SearchBaihuoMonthReportByFloor&date=' + vYear +
                ...
                $.post('/json/PublicHandler.ashx?Method=SearchBaihuoChartByMonth&date=' + vYear + '-' + vMon + '-' + vDay, function (item) {
                    var shop = item[0];
                    var sale = item[1];
                    var color = item[2];
                    var arr = new Array();
    ...
    <script type="text/javascript">
        function forward(obj) {
            ...
            URL = "baihuoFloorDetailMonthReport.aspx?FloorNo=" + FNo + "&FloorName=" + FName + "&date=" + date;
            location.href = URL;
        }
    </script> 
</head>
<body>
    ...
    <form id="form1" runat="server">
        <div data-role="page" class="type-interior">
            ...
            <div data-role="content">
                ...
                <div class="ui-grid-d" id="monthreport"></div><br />
                <div id="subhead" style="color:red; font-weight:700;display:none">楼层月销售占比分析</div><br />
    ...
    <script>
        ...
        $.post('/json/PublicHandler.ashx?Method=SearchBaihuoMonthReportByFloor&date=' + vYear + '-' + vMon + '-' + vDay, function (result) {
            if (result.success) {
                $("#monthreport").html(result.msg);
            }
            else {
