...
<html>
	...
	<body>
		<div class="navbar navbar-inverse">
			<div class="container">
					<ul class="nav nav-tabs" role="tablist" style="float:left;display:<?php echo ($display); ?>">
					...
					<form class="form-inline">
						<div class="form-group">
							<select id="year" name="year">
								<?php if(is_array($year)): $i = 0; $__LIST__ = $year;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo[1] == $curr_year){echo 'selected';} ?> value="<?php echo ($vo[1]); ?>"><?php echo ($vo[0]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					    	</select>
						</div>
						<div class="form-group">
