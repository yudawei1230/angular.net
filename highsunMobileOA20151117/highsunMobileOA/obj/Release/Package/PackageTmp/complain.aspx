...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //$("#istcomp").bind("click", function () {

            //    $.post('/json/PublicHandler.ashx?Method=insertComplain', $("#form1").formSerialize(), function (r) {
    ...
    <form id="form1" runat="server" enctype="multipart/form-data" data-ajax='false'>
        ...
        <div data-role="page" id="link">
            ...
            <div data-role="content">
                ...
                <a data-role="button" id="istcomp" data-rel="popup">弹出</a>
